                      ...
                      child: Column(
                        children: [
                          CircleAvatar(
                            ...
                            Text('Happy'),
                            ishappychosen?Icon(Icons.done,color: Colors.green,size: 25,):SizedBox()
                        ],
                      ),
                    ),
                    ...
                    GestureDetector(
                      ...
                      child: Column(
                        children: [
                          ...
                          Text('Sad'),
                          issadchosen?Icon(Icons.done,color: Colors.green,size: 25,):SizedBox()
                        ],
                      )),
                    // const SizedBox(width: 10,),
                    GestureDetector(
                      ...
                      child: Column(
                        children: [
                          ...
                          Text('Nuetral'),
                          isnuetralchosen?Icon(Icons.done,color: Colors.green,size: 25,):SizedBox()
                        ],
                      )),
                    // const SizedBox(width: 10,),
                    GestureDetector(
                      ...
                      child: Column(
                        children: [
                          ...
                          Text('Suprise'),
                          issuprisedchosen?Icon(Icons.done,color: Colors.green,size: 25,):SizedBox()
                        ],
                      )),
                    // const SizedBox(width: 10,),
                    GestureDetector(
                      ...
                      child: Column(
                        children: [
                          ...
                          Text('Fear'),
                          isfearchosen?Icon(Icons.done,color: Colors.green,size: 25,):SizedBox()
